...
|---|---------|------|-------------|
| C1 | [BS Degree Chatbot](/2026-02/docs/labs/week-4/capstone-bs-degree-chatbot/) | Week 04 | Hybrid RAG chatbot + RAGAS evaluation |
| C2 | [Autonomous Research Agent](/2026-02/docs/labs/week-5/capstone-autonomous-research-agent/) | Week 05 | LangChain daily research blog with memory, validation, and GitHub Actions |
